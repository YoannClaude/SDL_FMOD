...
class AudioEngine
{
    ...
    public:
        ...
        float GetEventParameter(const char* eventName, const char* parameterName, bool final);
        void SetEventParameter(const char* eventName, const char* parameterName, float value, bool ignoreSeekSpeed);
